!define PRODUCT_NAME "Excel_to_csv_desktop"
!define PRODUCT_VERSION "1.0"
!define PY_VERSION "3.6.3"
!define PY_MAJOR_VERSION "3.6"
!define BITNESS "64"
!define ARCH_TAG ".amd64"
!define INSTALLER_NAME "Excel_to_csv_desktop_1.0.exe"
...
!define MULTIUSER_INSTALLMODE_INSTDIR "Excel_to_csv_desktop"
...
Section "!${PRODUCT_NAME}" sec_app
  ...
  StrCmp $MultiUser.InstallMode CurrentUser 0 +3
    ...
    SetOutPath "$INSTDIR"
      File "glossyorb.ico"
      File "Excel_to_csv_desktop.launch.pyw"
  ...
  SetOutPath "%HOMEDRIVE%\%HOMEPATH%"
    CreateShortCut "$SMPROGRAMS\Excel_to_csv_desktop.lnk" "$INSTDIR\Python\pythonw.exe" \
      '"$INSTDIR\Excel_to_csv_desktop.launch.pyw"' "$INSTDIR\glossyorb.ico"
  SetOutPath "$INSTDIR"
...
Section "Uninstall"
  ...
  ; Uninstall files
    ...
    Delete "$INSTDIR\Excel_to_csv_desktop.launch.pyw"
  ; Uninstall directories
    RMDir /r "$INSTDIR\Python"

  ; Uninstall shortcuts
      Delete "$SMPROGRAMS\Excel_to_csv_desktop.lnk"
  RMDir $INSTDIR
